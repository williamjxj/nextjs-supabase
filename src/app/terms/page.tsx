...
export const metadata: Metadata = {
  ...
  description:
    'Terms of service for Gallery - Learn about our terms and conditions.',
}
        ...
        <div className='space-y-8'>
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              By accessing or using Gallery (&ldquo;the Service&rdquo;), you
              ...
              the Service. These Terms apply to all visitors, users, and others
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed mb-4'>
              Gallery is a web-based image hosting and management service that
              allows users to:
            </p>
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed mb-4'>
              You retain ownership of any intellectual property rights in
              content you upload to the Service (&ldquo;Your Content&rdquo;). By
              uploading Your Content, you grant us a worldwide, non-exclusive
            ...
            <p className='text-gray-700 leading-relaxed'>
              We reserve the right to review and remove any content that
              violates these Terms or is otherwise objectionable, but we are not
              obligated to monitor all content uploaded to the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed mb-4'>
              We offer various subscription plans that provide access to premium
              features. Subscription fees are charged in advance and are
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed mb-4'>
              ...
              are owned by Gallery and are protected by intellectual property
              laws. You may not copy, modify, distribute, sell, or lease any
              part of our Service without explicit permission.
            </p>
          </section>
          ...
          <section>
            ...
            <div className='bg-red-50 border border-red-200 p-4 rounded-lg'>
              <p className='text-gray-700 leading-relaxed'>
                TO THE FULLEST EXTENT PERMITTED BY LAW, GALLERY SHALL NOT BE
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              You agree to indemnify and hold harmless Gallery and its
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              ...
              principles. Any disputes shall be resolved in the courts of San
          ...
          <section>
            ...
            <div className='bg-gray-50 p-4 rounded-lg'>
              <p className='text-gray-700'>
                <strong>Email:</strong> legal@gallery.com
                <br />
                <strong>Address:</strong> Gallery Legal Team
                <br />
          ...
          <section className='border-t pt-8'>
            <p className='text-sm text-gray-500'>
              By using Gallery, you acknowledge that you have read, understood,
