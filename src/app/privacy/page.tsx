...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy for Gallery - Learn how we protect your data and privacy.',
}
        ...
        <div className='space-y-8'>
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              Welcome to Gallery (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
              &ldquo;us&rdquo;). We are committed to protecting your privacy and
              ensuring the security of your personal information. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your
              information when you use our image gallery service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 text-gray-700'>
              ...
              <li>
                <strong>Storage & Organization:</strong> To store and organize
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              ...
              our services and comply with legal obligations. Images and account
              data are retained while your account is active and for a
              reasonable period after account deletion to allow for recovery.
            </p>
          </section>
          ...
          <section>
            ...
            <p className='text-gray-700 leading-relaxed'>
              ...
              and updating the effective date. Your continued use of our service
          ...
          <section>
            ...
            <div className='bg-gray-50 p-4 rounded-lg'>
              <p className='text-gray-700'>
                <strong>Email:</strong> privacy@gallery.com
                <br />
                <strong>Address:</strong> Gallery Privacy Team
                <br />
