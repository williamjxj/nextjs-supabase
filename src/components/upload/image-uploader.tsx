...
const UploadProgress = ({ fileName, progress, status }: UploadProgressProps) => {
...
export const ImageUploader = () => {
  ...
  const { uploadFiles, uploading, progress, error } = useUpload();
  ...
  }, [selectedFiles, uploadFiles, error, addToast]);
    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        {selectedFiles.length > 0 && (
          <div>
            <h3 className="text-sm font-medium mb-3">Selected files ({selectedFiles.length})</h3>
